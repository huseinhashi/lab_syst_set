                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _buildSensorCard(
                          ...
                          _sensorData?['lightLevel'] == 1 ? Icons.wb_sunny : Icons.nightlight,
                          _sensorData?['lightLevel'] == 1 ? Colors.yellow : Colors.indigo,
                        ),
                        _buildSensorCard(
                          'System Status',
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _isRelayLoading ? null : () => _setAllRelays(true),
                          style: ElevatedButton.styleFrom(
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _isRelayLoading ? null : () => _setAllRelays(false),
                          style: ElevatedButton.styleFrom(
